...
import os
liability_api_request = Blueprint('auth_asset_api', __name__, template_folder='templates', static_folder='static')
...
@liability_api_request.route(f'/update', methods=['GET'])
def update():
...
@liability_api_request.route(f'/delete', methods=['GET'])
def delete():
